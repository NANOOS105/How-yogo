...
@WebServlet({ "/NoticeAllDeleteCon.do" })
public class NoticeAllDeleteCon extends HttpServlet {
	public NoticeAllDeleteCon() {
	}
	...
	protected void reqpro(HttpServletRequest request, HttpServletResponse response)
		...
		ndao.NoticeAllDelete();
		response.sendRedirect("NoticeListCon.do");
	}
}
